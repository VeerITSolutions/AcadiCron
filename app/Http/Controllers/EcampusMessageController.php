...
use App\Models\SendEcampusMessage;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class EcampusMessageController extends Controller
{
    /**
    ...
    public function index(Request $request, $id = null, $role = null)
    {
        ...
        $query = DB::table('send_ecampus_message')
            ->leftJoin(
                DB::raw('(SELECT send_ecampus_message_id, GROUP_CONCAT(role_id) as roles FROM notification_ecampus_message_roles GROUP BY send_ecampus_message_id) as notification_ecampus_message_roles'),
                'notification_ecampus_message_roles.send_ecampus_message_id',
                '=',
    ...
    public function create(Request $request)
    {
        ...
        try {
            ...
            // Create a new SendEcampusMessage instance
            $notification = new SendEcampusMessage();
            ...
            /*  */
            $notification = SendEcampusMessage::findOrFail($notification->id);
    ...
    public function update(Request $request, string $id)
    {
        ...
        $notification = SendEcampusMessage::findOrFail($id);
