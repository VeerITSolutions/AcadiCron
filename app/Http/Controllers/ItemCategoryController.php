...
class ItemCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data = ItemCategory::orderBy('id', 'desc')->paginate($perPage, ['*'], 'page', $page);
    ...
    public function create(Request $request)
    {
        ...
        $ItemCategory->item_category = $validatedData['item_category'];
        $ItemCategory->description = $validatedData['description'];
