...
class RoomTypesController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        // Create a new RoomTypes
        $RoomTypes = new RoomTypes();
        $RoomTypes->room_type = $validatedData['room_type'];
        $RoomTypes->description = $validatedData['description'];
        ...
        return response()->json([
            'success' => true,
            'message' => 'RoomTypes  saved successfully',
            'RoomTypes' => $RoomTypes,
    ...
    public function destroy($id)
    {
        try {
            ...
            return response()->json(['success' => true, 'message' => 'RoomTypes  deleted successfully']);
        } catch (\Exception $e) {
            // Handle failure (e.g. if the RoomTypes was not found)
