    ...
    <div class="" style="position: relative; text-align: center; font-family: 'arial';">
        ...
        <table width="100%" cellspacing="0" cellpadding="0"
            ...
            <tr>
                ...
                <td valign="top" style="text-align:left; position: relative; <?php echo 'top:' . $certificate->header_height . 'px'; ?>"><?php echo $certificate->left_header; ?>
                </td>
            ...
            <tr style="">
                ...
                <td valign="top" style="text-align:center;position: relative; <?php echo 'top:' . $certificate->footer_height . 'px'; ?>">
                    <?php echo $certificate->center_footer; ?>
                </td>

                <td valign="top" style="text-align:right;position: relative; <?php echo 'top:' . $certificate->footer_height . 'px'; ?>">
