...
<head>
    ...
    <link href="<?php echo base_url(); ?>uploads/school_content/admin_small_logo/<?php $this->setting_model->getAdminsmalllogo(); ?>" rel="shortcut icon"
        type="image/x-icon">
        ...
        <div class="slidealert">
            ...
            <div class="alert alert-dismissible topaleart-inside">
                ...
                <p class="palert"><strong>Alert!</strong> You are using unregistered version of Smart School. Please <a
                        href="#" class="purchasemodal">click here</a> to register your purchase code for Smart
                    School.</p>
                    ...
                    <div class="pull-right">
                        ...
                        <form id="header_search_form" class="navbar-form navbar-left search-form" role="search"
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" value="<?php echo set_value('search_text1'); ?>" name="search_text1"
...
if ($this->module_lib->hasActive('calendar_to_do_list')) {
    ...
    if ($this->rbac->hasPrivilege('calendar_to_do_list', 'can_view')) {
        ...
        ?>
                                ...
                                <li class="cal15"><a data-placement="bottom" data-toggle="tooltip"
        ...
        if ($count > 0) {
            ...
            ?>
                                    ...
                                    <ul class="dropdown-menu menuboxshadow">
                                        ...
                                        <li class="todoview plr10 ssnoti"><?php echo $this->lang->line('today_you_have'); ?> <?php echo $count; ?>
                                            <?php echo $this->lang->line('pending_task'); ?><a href="<?php echo base_url(); ?>admin/calendar/events"
        ...
        foreach ($tasklist as $key => $value) {
            ...
            ?>
                                ...
                                <li class="cal15"><a data-placement="bottom" data-toggle="tooltip" title=""
                                        ...
                                        data-original-title="<?php echo $this->lang->line('chat'); ?>" class="todoicon"><i
                                        ...
                                        <li>
                                            ...
                                            <div class="sstopuser">
                                                ...
                                                <div class="ssuserleft">
                                                    ...
                                                    <a href="<?php echo base_url() . 'admin/staff/profile/' . $id; ?>"><img src="<?php echo base_url() . $file; ?>"
                                                            alt="User Image"></a>
                                                ...
                                                <div class="sspass">
                                                    ...
                                                    <a href="<?php echo base_url() . 'admin/staff/profile/' . $id; ?>" data-toggle="tooltip"
                                                        title="" data-original-title="<?php echo $this->lang->line('my_profile'); ?>"><i
                                                    ...
                                                    <a class="pl25"
                                                        ...
                                                        data-original-title="<?php echo $this->lang->line('change_password'); ?>"><i
                                                            class="fa fa-key"></i><?php echo $this->lang->line('password'); ?></a> <a
                                                        class="pull-right" href="<?php echo base_url(); ?>site/logout"><i
