...
if ($this->module_lib->hasActive('student_information')) {
    ...
    if(@$this->session->userdata["admin"]["roles"]["Teacher"]!=2){
...
if ($this->rbac->hasPrivilege('notice_board', 'can_view')) {
        ...
        if ($this->rbac->hasPrivilege('email', 'can_view')) {
            ...
            ?>
                                ...
                                <li style="display:none;" class="<?php echo set_Submenu('Communicate/mailsms/compose'); ?>"><a href="<?php echo base_url(); ?>admin/mailsms/compose"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('send') . " " . $this->lang->line('email') ?></a></li>
        ...
        if ($this->rbac->hasPrivilege('sms', 'can_view')) {
            ...
            ?>
                                ...
                                <li style="display:none;" class="<?php echo set_Submenu('mailsms/compose_sms'); ?>"><a href="<?php echo base_url(); ?>admin/mailsms/compose_sms"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('send') . " " . $this->lang->line('sms') ?></a></li>
        ...
        if ($this->rbac->hasPrivilege('email_sms_log', 'can_view')) {
            ...
            ?>
                                ...
                                <li style="display:none;" class="<?php echo set_Submenu('mailsms/index'); ?>"><a href="<?php echo base_url(); ?>admin/mailsms/index"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('email_/_sms_log'); ?></a></li>

                    <?php }?>

						

							<li style="display:none;" class="<?php echo set_Submenu('bulk_mail'); ?>"><a href="<?php echo base_url(); ?>student/bulkmail"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('login_credentials_send'); ?></a></li>
...
if ($this->rbac->hasPrivilege('student_certificate', 'can_view')) {
        ...
        if ($this->rbac->hasPrivilege('student_id_card', 'can_view')) {
            ...
            ?>
                                ...
                                <li style="display:none;" class="<?php echo set_Submenu('admin/studentidcard'); ?>"><a href="<?php echo base_url('admin/studentidcard/'); ?>"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('student'); ?> <?php echo $this->lang->line('icard'); ?></a></li>
        ...
        if ($this->rbac->hasPrivilege('generate_id_card', 'can_view')) {
            ...
            ?>
                                ...
                                <li style="display:none;" class="<?php echo set_Submenu('admin/generateidcard'); ?>"><a href="<?php echo base_url('admin/generateidcard/search'); ?>"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('generate'); ?> <?php echo $this->lang->line('icard'); ?></a></li>
        ...
        if ($this->rbac->hasPrivilege('staff_id_card', 'can_view')) {
            ...
            ?>
                                ...
                                <li style="display:none;" class="<?php echo set_Submenu('admin/staffidcard'); ?>"><a href="<?php echo base_url('admin/staffidcard/'); ?>"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('staff'); ?> <?php echo $this->lang->line('icard'); ?></a></li>
        ...
        if ($this->rbac->hasPrivilege('generate_staff_id_card', 'can_view')) {
            ...
            ?>
                                ...
                                <li style="display:none;" class="<?php echo set_Submenu('admin/generatestaffidcard'); ?>"><a href="<?php echo base_url('admin/generatestaffidcard/'); ?>"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('generate'); ?> <?php echo $this->lang->line('staff'); ?> <?php echo $this->lang->line('icard'); ?></a></li>
...
if ($this->module_lib->hasActive('reports')) {
    ...
    if (($this->rbac->hasPrivilege('student_report', 'can_view') ||
        ...
        ?>
                    ...
                    <li  style="display:none;"  class="treeview <?php echo set_Topmenu('Reports'); ?>">
...
if ($this->module_lib->hasActive('system_settings')) {
    ...
    if (($this->rbac->hasPrivilege('general_setting', 'can_edit') ||
        ...
        ?>
                    ...
                    <li  style="display:none;"  class="treeview <?php echo set_Topmenu('System Settings'); ?>">
...
if ($this->rbac->hasPrivilege('general_setting', 'can_view')) {
        ...
        ?>
                                ...
                                <li style="display:none;" class="<?php echo set_Submenu('System Settings/onlineadmissionsetting'); ?>"><a href="<?php echo base_url(); ?>admin/onlineadmission/admissionsetting"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('online_admission_setting') ?></a></li>
