             ...
             <ul class="sessionul fixedmenu">
                 ...
                 <li style="display:none;" class="dropdown">
                     ...
                     <ul class="dropdown-menu verticalmenu" style="min-width:194px;font-size:10pt;left:3px;">
                         ...
                         <li role="presentation"><a style="color:#282828; font-family: 'Roboto-Bold';padding:6px 20px;"
                                 role="menuitem" tabindex="-1" href="https://erp.erabesa.co.in/admin/stuattendence"><i
                         ...
                         <li role="presentation"><a style="color:#282828; font-family: 'Roboto-Bold';padding:6px 20px;"
                                 role="menuitem" tabindex="-1" href="https://erp.erabesa.co.in/admin/examgroup"><i
                                     class="fa fa-map-o"></i>Exam
                                 Group</a></li>


                         <li role="presentation"><a style="color:#282828; font-family: 'Roboto-Bold';padding:6px 20px;"
                                 role="menuitem" tabindex="-1" href="https://erp.erabesa.co.in/admin/examresult"><i
                         ...
                         <li role="presentation"><a
                                 ...
                                 tabindex="-1" href="https://erp.erabesa.co.in/admin/enquiry"><i
                                     class="fa fa-calendar-check-o"></i>Admission Enquiry</a></li>

                         <li role="presentation"><a
                                 style="color:#282828; font-family: 'Roboto-Bold';padding:6px 20px;" role="menuitem"
                                 tabindex="-1" href="https://erp.erabesa.co.in/admin/complaint"><i
                                     class="fa fa-calendar-check-o"></i>Complain</a></li>

                         <li role="presentation"><a
                                 style="color:#282828; font-family: 'Roboto-Bold';padding:6px 20px;" role="menuitem"
                                 tabindex="-1" href="https://erp.erabesa.co.in/admin/content"><i
                                     class="fa fa-download"></i>Upload Content</a></li>


                         <li role="presentation"><a
                                 style="color:#282828; font-family: 'Roboto-Bold';padding:6px 20px;" role="menuitem"
                                 tabindex="-1" href="https://erp.erabesa.co.in/admin/itemstock"><i
                                     class="fa fa-object-group"></i>Add Item Stock</a></li>


                         <li role="presentation"><a
                                 style="color:#282828; font-family: 'Roboto-Bold';padding:6px 20px;" role="menuitem"
                                 tabindex="-1" href="https://erp.erabesa.co.in/admin/notification"><i
                                     class="fa fa-bullhorn"></i>Notice Board</a></li>

                         <li role="presentation"><a
                                 style="color:#282828; font-family: 'Roboto-Bold';padding:6px 20px;" role="menuitem"
                                 tabindex="-1" href="https://erp.erabesa.co.in/admin/mailsms/compose"><i
             ...
             <ul class="sidebar-menu verttop">
                 ...
                 <li class="treeview ">
                     ...
                     <ul class="treeview-menu">
                         ...
                         <li class=""><a href="https://erp.erabesa.co.in/admin/teacher/assign_class_teacher"><i
