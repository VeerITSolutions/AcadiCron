...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <form id="form1" action="<?php echo base_url() ?>admin/notification/edit/<?php echo $id ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                    <?php
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-3">
                              ...
                              <div  class='row'>
                                <div class="col-md-12">
                                <div class="col-md-6">
                                     <label for="exampleInputEmail1"> <i class="fa fa-upload"></i> Upload File</label>
                                      
                                       <span><input class="btn btn-primary form-control" type='file' name='userfile2'  /></span>
