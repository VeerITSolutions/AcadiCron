                ...
                <div class="">
                    ...
                    <table width="100%"> 
                        ...
                        <tr>
                            ...
                            <td class="head-td" style="height: 100px;width: 850px;">

                                <div class="header-slip" >
                                    <div ><img src="<?php echo base_url() ?>/uploads/school_content/admin_small_logo/1.png"/>
                                    <span style="float:right"><h3>Era International School</h3>
                                        <p>Revati nagar, Besa,</p><p>Nagpur(M.S.) 440027 </p></span></div>
                                    <!-- <img src="<?php echo base_url() ?>/uploads/print_headerfooter/staff_payslip/<?php $this->setting_model->get_payslipheader(); ?>" style="width: 100%;" /> -->
                                </div>
                                <div class="slipBlack">PaySlip</div>
