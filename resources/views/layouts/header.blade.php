...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('backend/dist/themes/white/skins/_all-skins.min.css') }}">
    <link rel="stylesheet" href="{{ asset('backend/dist/themes/white/ss-main.css') }}">
    ...
    <script src="{{ asset('backend/js/school-admin-custom.js') }}"></script>
    ...
    <link rel="stylesheet" href="{{ asset('backend/fullcalendar/dist/fullcalendar.print.min.css') }} ">
