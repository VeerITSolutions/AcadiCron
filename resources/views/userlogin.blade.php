                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 nopadding <?php echo $bgoffsetbgno; ?> <?php echo $offset; ?>">
                            ...
                            <div class="loginbg loginradius login390">
                                ...
                                <div class="form-bottom">
                                    ...
                                    <form action="<?php echo site_url('site/userlogin'); ?>" method="post">
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <input type="text" name="username" value="<?php echo set_value('username'); ?>"
                                                placeholder="<?php echo $this->lang->line('username'); ?>" class="form-username form-control"
                                                id="email">
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <input type="password" name="password" value="<?php echo set_value('password'); ?>"
                                                placeholder="<?php echo $this->lang->line('password'); ?>" class="form-password form-control"
                                                id="password">
                                        ...
                                        <div class="form-group has-feedback row">
                                            ...
                                            <div class='col-lg-7 col-md-12 col-sm-6'>
                                                ...
                                                <span class="fa fa-refresh catpcha" title='Refresh Catpcha'
                                            ...
                                            <div class='col-lg-5 col-md-12 col-sm-6'>
                                                ...
                                                <input type="text" name="captcha" placeholder="<?php echo $this->lang->line('captcha'); ?>"
                                                    autocomplete="off" class=" form-control" id="captcha">
                                    ...
                                    <p><a href="<?php echo site_url('site/ufpassword'); ?>" class="forgot"> <i class="fa fa-key"></i>
