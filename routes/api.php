...
Route::match(['get', 'post'], '/admin/feesStudentList', [StudentListController::class, 'getDueStudentFees']);
...
Route::get('/fees-session-by-group/{id}', [FeeSessionGroupsController::class, 'showSingle']);
...
Route::get('/teacher-review-get-rated-staff', [StaffRatingController::class, 'getRatedStaff']);
...
Route::post('/staff-disabled', [StaffController::class, 'StaffDisabled']);
